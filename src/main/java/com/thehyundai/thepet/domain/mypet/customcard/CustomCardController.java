...
public class CustomCardController {
    ...
    public ResponseEntity<?> saveCustomCardDesign(@RequestHeader(HEADER_TOKEN_PARAM) String token,
                                                  @RequestParam MultipartFile frontImgFile,
                                                  @RequestParam MultipartFile backImgFile) {
        CustomCardVO result = customCardService.saveCustomCardDesign(token, frontImgFile, backImgFile);
